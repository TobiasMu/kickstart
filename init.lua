...
require('lazy').setup {
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- LSP servers and clients are able to communiate to each other what features they support.
      ...
      --  - filetypes (table): Override the default ated filetypes for the server
